...
<!--               <li class="sidebar-list-item"><a href="charts.html" class="sidebar-link text-muted"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Charts</span></a></li> -->
              ...
              <li class="sidebar-list-item"><a href="<?= base_url();?>core/barangkeluar" class="<?php if($title == 'Barang Keluar'){echo 'sidebar-link text-muted active';} else{echo 'sidebar-link text-muted';} ?>"><i class="o-exit-1 mr-3 text-gray"></i><span> Barang Keluar</span></a></li>
        ...
        <div class="text-gray-400 text-uppercase px-3 px-lg-4 py-4 font-weight-bold small headings-font-family"><a href="">Buat Invoice</a></div>
        <!-- <ul class="sidebar-menu list-unstyled">
